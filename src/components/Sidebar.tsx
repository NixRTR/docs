  ...
  const menuItems = [
    ...
    { path: '/verification', label: 'Verification' },
    {
      ...
      children: [
        ...
        { path: '/webui/cake', label: 'CAKE' },
        { path: '/webui/blocklists', label: 'Blocklists' },
        { path: '/webui/port-forwarding', label: 'Port Forwarding' },
        { path: '/webui/dyndns', label: 'Dynamic DNS' },
        { path: '/webui/worker-status', label: 'Worker Status' },
        { path: '/webui/logs', label: 'Logs' },
        { path: '/webui/traffic-shaping', label: 'Traffic Shaping' },
        { path: '/webui/documentation', label: 'Documentation' },
      ],
    },
  ];
